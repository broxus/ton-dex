...
locklift run --config locklift.config.js --network dev --script scripts/0-deploy-account.js --key_number='0' --balance='50'
locklift run --config locklift.config.js --network dev --script scripts/0-deploy-account.js --key_number='1' --balance='50'
locklift run --config locklift.config.js --network dev --script scripts/0-deploy-account.js --key_number='2' --balance='50'
locklift run --config locklift.config.js --network dev --script scripts/0-deploy-TokenFactory.js
locklift run --config locklift.config.js --network dev --script scripts/1-deploy-vault-and-root.js --pair_contract_name='DexPairV2'
...
locklift run --config locklift.config.js --network dev --script scripts/4-deploy-test-dex-account.js
locklift run --config locklift.config.js --network dev --script scripts/5-deploy-test-pair.js --pairs='[["foo", "bar"]]' --contract_name='DexPairV2'
locklift test --config locklift.config.js --network dev --tests test/00-token-factory-test.js
locklift test --config locklift.config.js --network dev --tests test/01-base-root-and-vault-test.js --pair_contract_name='DexPairV2'
locklift test --config locklift.config.js --network dev --tests test/08-deposit-test.js
locklift test --config locklift.config.js --network dev --tests test/09-add-pair-test.js --left='foo' --right='bar' --account=2 --contract_name='DexPairV2'
locklift test --config locklift.config.js --network dev --tests test/10-deposit-to-dex-account.js --deposits='[{ "tokenId": "foo", "amount": 1000000 }, { "tokenId": "bar", "amount": 1000000 }]'
...
locklift test --config locklift.config.js --network dev --tests test/35-upgrade-pair.js --left='foo' --right='bar' --old_contract_name='DexPairV2' --new_contract_name='DexPairV3'

#check problem solved
locklift test --config locklift.config.js --network dev --tests test/12-pair-deposit-liquidity.js --left_token_id 'foo' --right_token_id 'bar' --left_amount '3800' --right_amount '838.4260921287559342' --auto_change 'true' --contract_name='DexPairV2'

# test deploy v3
locklift run --config locklift.config.js --network dev --script scripts/5-deploy-test-pair.js --pairs='[["bar", "qwe"]]' --contract_name='DexPairV3'
...
locklift test --config locklift.config.js --network dev --tests test/10-deposit-to-dex-account.js --deposits='[{ "tokenId": "qwe", "amount": 1000000 }]'
...
#old tests
locklift test --config locklift.config.js --network dev --tests test/15-dex-account-pair-operations.js --contract_name='DexPairV3'
...
locklift test --config locklift.config.js --network dev --tests test/40-cross-pair-exchange.js --amount=1000 --route='["foo","bar","qwe"]' --contract_name='DexPairV3'
