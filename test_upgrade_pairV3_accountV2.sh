...
locklift test --config locklift.config.js --network prod --tests test/01-base-root-and-vault-test.js --pair_contract_name='DexPairV2' --account_contract_name='DexAccountV2'
