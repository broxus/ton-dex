...
locklift run --config locklift.config.js --network local --script scripts/1-deploy-vault-and-root.js --pair_contract_name='DexPair'
...
#locklift test --config locklift.config.js --network local --tests test/31-install-account-code.js --contract_name='DexAccount'
