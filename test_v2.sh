...
locklift test --config locklift.config.js --network dev --tests test/40-cross-pair-exchange.js --amount=1000 --route='["bar","foo","qwe"]' --contract_name='DexPairV2'
locklift test --config locklift.config.js --network dev --tests test/40-cross-pair-exchange.js --amount=1000 --route='["foo","qwe","bar","tst"]' --contract_name='DexPairV2'
